...
`
  ...
  // 用到的库
  const LIBS = [
    'http://127.0.0.1/Live2d/live2d/lib/pio.css',
    'http://127.0.0.1/Live2d/dist/TweenLite.js',
    'http://127.0.0.1/Live2d/cubismcore/live2dcubismcore.min.js',
    'http://127.0.0.1/Live2d/dist/pixi.min.js',
    'http://127.0.0.1/Live2d/dist/cubism4.min.js',
    'http://127.0.0.1/Live2d/live2d/lib/pio_sdk4.js',
    'http://127.0.0.1/Live2d/live2d/lib/pio.js'
  ]
...
//   夜间模式控件
  night: "toggleNightMode()",
    model: [
      // 待加载的模型列表
      "http://127.0.0.1/Live2d/live2d/Diana/Diana.model3.json",
      "http://127.0.0.1/Live2d/live2d/Ava/Ava.model3.json",
